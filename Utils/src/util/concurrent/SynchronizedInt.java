...
public class SynchronizedInt extends SynchronizedVariable implements Comparable, Cloneable {
   ...
   * @author sereda
   */
  public int compareAndIncrement(int assumedValue, int increment) {
    synchronized (lock_) {
      int result = value_;
  ...
  public boolean waitForValue(final int value, long timeout) throws InterruptedException {
  ...
  public int waitForValueInRange(final int minValue, final int maxValue, long timeout) throws InterruptedException {
    synchronized (lock_) {
