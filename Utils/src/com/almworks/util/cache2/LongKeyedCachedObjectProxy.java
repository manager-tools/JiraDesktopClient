...
public abstract class LongKeyedCachedObjectProxy<T extends LongKeyedCachedObject> extends LongKeyed {
...
//  private static final Map<StackKey, Integer> callers = Collections15.hashMap();
  ...
  protected LongKeyedCachedObjectProxy(long key) {
    super(key);
/*
PROFILING
    count.a();
...
//      if (!(obj instanceof LongKeyedCachedObjectProxy.StackKey))
//        return false;
//      LongKeyedCachedObjectProxy.StackKey that = (LongKeyedCachedObjectProxy.StackKey) obj;
...
//  }
  ...
  protected abstract LRULongCache<T> getCache();
