/*
 * $Header: /cvsroot/main/PATCHED/commons-httpclient-3.0/src/java/org/apache/commons/httpclient/methods/multipart/FilePart.java,v 1.2 2008-02-09 12:20:09 sereda Exp $
 * $Revision: 1.2 $
 * $Date: 2008-02-09 12:20:09 $
 *
 * ====================================================================
 *
...
public class FilePart extends PartBase {
    ...
    throws FileNotFoundException {
        this(name, new FilePartSource(file, charset), contentType, charset);
    }
    ...
    throws IOException {
        ...
        String filenameEncoding = this.source.getFileNameEncoding();
        if (filenameEncoding == null)
           filenameEncoding = "UTF-8";
        if (filename != null) {
            out.write(FILE_NAME_BYTES);
            out.write(QUOTE_BYTES);
            out.write(EncodingUtil.getBytes(filename, filenameEncoding));
            out.write(QUOTE_BYTES);
        }
    }
