/*
 * $Header: /cvsroot/main/PATCHED/commons-httpclient-3.0/src/java/org/apache/commons/httpclient/methods/multipart/ByteArrayPartSource.java,v 1.2 2008-02-09 12:20:09 sereda Exp $
 * $Revision: 1.2 $
...
public class ByteArrayPartSource implements PartSource {
  ...
  public ByteArrayPartSource(String fileName, byte[] bytes, String filenameEncoding) {
    this(fileName, bytes);
