 ...
 * <p/>
 * All classes except Synchronized and WaitableRef implement
 ...
 * correspond to their java.lang analogs. Synchronized does not
...
public class SynchronizedVariable implements Executor {
  ...
  public void execute(Runnable command) {
    if (Thread.interrupted()) throw new RuntimeInterruptedException(new InterruptedException());
    synchronized (lock_) {
      command.run();
    }
  }

  protected boolean waitForCondition(Checker checker, long timeout) throws InterruptedException {
